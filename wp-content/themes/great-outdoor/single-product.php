...
<section class="main-content has-sidebar product-page">
	...
	<div class="product-info">
		...
		<h2 class="section-header orange left"><small>Patagonia </small>Tonnerro Down Jacket</h2>

		<p class="product-info-text">Lorem ipsum sit amet...</p>
		...
		<ul class="activities-available availability-list">
			<li class="camp-hike">Camp/Hike</li>
			<li class="climb">Climb</li>
