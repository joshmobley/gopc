...
<section class="main-content">
    ...
    <div class="page-section half-container">
        ...
        <div class="half-width promo social-links">
            ...
            <a href="<?php echo $facebook; ?>" target="_blank" class="facebook-link">Local Facebook</a>
            <a href="<?php echo $twitter; ?>" target="_blank" class="twitter-link">Local Twitter</a>
            <a href="<?php echo $instagram; ?>" target="_blank" class="instagram-link">Local Instagram</a>
